return {
  ...
  [4] = {
    ...
    objs = {
      ...
      {'bloom', 0, 6},
      {'pollen', 1, 3, group = 1, image = '1.1'},
      {'pollen', 1, 4, group = 1, image = '1.2'},
      {'pollen', 2, 5, group = 2, image = '1.1'},
      {'pollen', 2, 6, group = 2, image = '1.2'},
      {'butterfly', 1, 1, dir = 1},
    },
  },
  ...
  [9] = {
    ...
    objs = {
      ...
      {'pollen', 3, 5, group = 2, image = '1.1'},
      {'pollen', 3, 6, group = 2, image = '1.2'},
      {'butterfly', 1, 0, dir = 1},
      {'butterfly', 4, 4, dir = 4},
    },
  },
  ...
  [14] = {
    ...
    objs = {
      ...
      {'pollen', 0, 3, group = 1, image = '1.1'},
      {'pollen', 1, 3, group = 1, image = '1.2'},
      {'pollen', 2, 0, group = 2, image = '1.1'},
      {'pollen', 2, 1, group = 2, image = '1.2'},
  ...
  [15] = {
    ...
    objs = {
      ...
      {'pollen', 1, 1, group = 1, image = '1.1'},
      {'pollen', 1, 5, group = 1, image = '1.2'},
      {'pollen', 0, 1, group = 2, image = '1.1'},
      {'pollen', 0, 5, group = 2, image = '1.2'},
      {'pollen', 2, 1, group = 3, image = '1.1'},
      {'pollen', 2, 5, group = 3, image = '1.2'},
      {'butterfly', 1, 2, dir = 1},
    },
  },
  ...
  [22] = {
    ...
    objs = {
      ...
      {'weeds', 2, 2},
      {'bloom', 2, 5},
      {'pollen', 2, 7, group = 1, image = '1.1'},
      {'pollen', 2, 8, group = 1, image = '1.2'},
      {'pollen', 1, 5, group = 2, image = '1.1'},
      {'pollen', 1, 6, group = 2, image = '1.2'},
      {'pollen', 3, 5, group = 3, image = '1.1'},
      {'pollen', 3, 6, group = 3, image = '1.2'},
  ...
  [23] = {
    ...
    objs = {
      ...
      {'pollen', 5, 1, group = 2, image = '1.1'},
      {'pollen', 5, 2, group = 2, image = '1.2'},
  ...
  [24] = {
    ...
    objs = {
      ...
      {'bloom', 1, 6},
      {'bloom', 1, 7},
      {'pollen', 1, 2, group = 1, image = '1.1'},
      {'pollen', 1, 8, group = 1, image = '1.2'},
      {'pollen', 3, 2, group = 2, image = '1.1'},
      {'pollen', 3, 4, group = 2, image = '1.2'},
      {'pollen', 1, 5, group = 3, image = '1.1'},
      {'pollen', 3, 5, group = 3, image = '1.2'},
      {'chameleon', 2, 5, range_x = -3},
      {'butterfly', 2, 1, dir = 1},
    },
  },
  ...
  [25] = {
    ...
    objs = {
      ...
      {'pollen', 6, 4, group = 2, image = '1.1'},
      {'pollen', 7, 4, group = 2, image = '1.2'},
      {'pollen', 6, 6, group = 3, image = '1.1'},
      {'pollen', 7, 6, group = 3, image = '1.2'},
      {'butterfly', 0, 3, dir = 2},
    },
  },
  [26] = {
    ...
    objs = {
      ...
      {'pollen', 3, 1, group = 1, image = '1.1'},
      {'pollen', 3, 2, group = 1, image = '1.2'},
      {'pollen', 5, 1, group = 2, image = '1.1'},
      {'pollen', 5, 2, group = 2, image = '1.2'},
      {'butterfly', 1, 4, dir = 1},
    },
  ...
  [27] = {
    ...
    objs = {
      ...
      {'bloom', 3, 6},
      {'bloom', 5, 6},
      {'pollen', 3, 8, group = 1, image = '1.1'},
      {'pollen', 3, 9, group = 1, image = '1.2'},
      {'pollen', 5, 8, group = 2, image = '1.1'},
      {'pollen', 5, 9, group = 2, image = '1.2'},
  ...
  [28] = {
    ...
    objs = {
      ...
      {'pollen', 3, 4, group = 1, image = '1.2'},
      {'pollen', 1, 5, group = 2, image = '1.1'},
      {'pollen', 2, 5, group = 2, image = '1.2'},
      {'pollen', 2, 1, group = 3, image = '1.1'},
      {'pollen', 2, 2, group = 3, image = '1.2'},
      {'butterfly', 4, 4, dir = 1},
    },
  },
  [29] = {
    ...
    objs = {
      ...
      {'pollen', 3, 6, group = 1, image = '1.1'},
      {'pollen', 2, 4, group = 1, image = '1.2'},
      {'pollen', 4, 6, group = 2, image = '1.1'},
      {'pollen', 4, 7, group = 2, image = '1.2'},
      {'butterfly', 3, 2, dir = 1},
    },
  },
}
