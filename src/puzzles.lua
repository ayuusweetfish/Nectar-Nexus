return {
  ...
  debug_arrows = false,   -- Whether allow arrow key for quick navigation between puzzles
  ...
  [3] = {
    ...
    objs = {
      {'bloom', 0, 8},
      {'pollen', 2, 3, group = 1, image = '1.1'},
      {'pollen', 2, 4, group = 1, image = '1.2'},
      {'pollen', 2, 5, group = 2, image = '3.2', rotation = -1},
      {'pollen', 1, 7, group = 2, image = '3.1'},
      {'butterfly', 2, 1, dir = 1},
    },
  },
  ...
  [6] = {
    ...
    objs = {
      ...
      {'bloom', 2, 5},
      {'pollen', 1, 4, group = 1, image = '3.1'},
      {'pollen', 1, 3, group = 1, image = '3.2', rotation = 2},
  ...
  [9] = {
    ...
    objs = {
      {'bloom', 2, 2},
      {'bloom', 2, 3},
      {'pollen', 2, 5, group = 1, image = '1.1'},
      {'pollen', 2, 6, group = 1, image = '1.2'},
      {'pollen', 3, 5, group = 2, image = '3.1'},
      {'pollen', 3, 6, group = 2, image = '3.2'},
      {'butterfly', 1, 0, dir = 1},
      {'butterfly', 4, 4, dir = 4},
    },
  },
  ...
  [10] = {
    ...
    objs = {
      ...
      {'bloom', 2, 6},
      {'bloom', 1, 7},
      {'pollen', 2, 5, group = 1, image = '2.1'},
      {'pollen', 2, 7, group = 1, image = '2.2'},
      {'pollen', 3, 3, group = 2, image = '1.1'},
      {'pollen', 5, 3, group = 2, image = '1.2'},
      {'pollen', 4, 1, group = 3, image = '4.1'},
      {'pollen', 4, 5, group = 3, image = '4.2'},
      {'butterfly', 1, 0, dir = 1},
      {'butterfly', 2, 3, dir = 1},
    },
  },
  ...
  [11] = {
    ...
    objs = {
      {'bloom', 2, 0},
      {'weeds', 2, 4},
      {'pollen', 0, 1, group = 1, image = '2.1'},
      {'pollen', 0, 3, group = 1, image = '2.2'},
  ...
  [12] = {
    ...
    objs = {
      ...
      {'bloom', 1, 5},
      {'weeds', 2, 3},
      {'pollen', 0, 3, group = 1, image = '1.1'},
      {'pollen', 1, 3, group = 1, image = '1.2'},
      {'pollen', 2, 1, group = 2, image = '1.1'},
      {'pollen', 2, 2, group = 2, image = '1.2'},
      {'pollen', 2, 4, group = 3, image = '1.1'},
      {'pollen', 2, 5, group = 3, image = '1.2'},
      {'butterfly', 3, 3, dir = 2},
    },
  },
  ...
  [13] = {
    ...
    objs = {
      ...
      {'bloom', 1, 4},
      {'weeds', 1, 3},
      {'pollen', 1, 0, group = 1, image = '1.2', rotation = -1},
      {'pollen', 1, 5, group = 1, image = '1.1', rotation = 1},
      {'pollen', 1, 1, group = 2, image = '4.1'},
      {'pollen', 1, 6, group = 2, image = '4.2'},
      {'pollen', 3, 5, group = 3, image = '2.2'},
      {'pollen', 3, 6, group = 3, image = '2.1'},
      {'butterfly', 0, 2, dir = 1},
    },
  },
  [14] = {
    ...
    objs = {
      ...
      {'bloom', 3, 4},
      {'weeds', 2, 3},
      {'pollen', 0, 3, group = 1, image = '3.2'},
      {'pollen', 1, 3, group = 1, image = '3.1'},
      {'pollen', 2, 0, group = 2, image = '4.1'},
      {'pollen', 2, 1, group = 2, image = '4.2'},
      {'pollen', 2, 5, group = 3, image = '1.1'},
      {'pollen', 2, 6, group = 3, image = '1.2'},
      {'pollen', 3, 5, group = 4, image = '4.1', rotation = -0.2},
      {'pollen', 3, 6, group = 4, image = '4.2'},
      {'butterfly', 1, 2, dir = 1},
    },
  },
  [15] = {
    ...
    objs = {
      ...
      {'pollen', 0, 1, group = 2, image = '3.1'},
      {'pollen', 0, 5, group = 2, image = '3.2'},
      {'pollen', 2, 1, group = 3, image = '2.1'},
      {'pollen', 2, 5, group = 3, image = '2.2'},
      {'butterfly', 1, 2, dir = 1},
    },
  },
  [16] = {
    ...
    objs = {
      ...
      {'bloom', 3, 3},
      {'pollen', 0, 3, group = 1, image = '3.2'},
      {'pollen', 0, 4, group = 1, image = '3.1'},
      {'pollen', 2, 3, group = 2, image = '4.1'},
      {'pollen', 2, 4, group = 2, image = '4.2'},
      {'pollen', 4, 3, group = 3, image = '1.1'},
      {'pollen', 4, 4, group = 3, image = '1.2'},
      {'butterfly', 2, 0, dir = 1},
    },
  },
  ...
  [17] = {
    ...
    objs = {
      ...
      {'bloom', 2, 1},
      {'pollen', 2, 4, group = 1, image = '1.1'},
      {'pollen', 3, 4, group = 1, image = '1.2'},
      {'butterfly', 0, 4, dir = 3},
    },
  },
  -- Mild difficulty
  [18] = {
    ...
    objs = {
      ...
      {'bloom', 2, 1},
      {'bloom', 1, 3},
      {'pollen', 0, 2, group = 1, image = '1.1'},
      {'pollen', 1, 2, group = 1, image = '1.2'},
      {'pollen', 2, 3, group = 2, image = '4.1'},
      {'pollen', 2, 4, group = 2, image = '4.2'},
      {'butterfly', 3, 4, dir = 3},
      {'butterfly', 4, 4, dir = 3},
  ...
  [19] = {
    ...
    objs = {
      ...
      {'bloom', 3, 7},
      {'bloom', 4, 7},
      {'pollen', 1, 1, group = 1, image = '3.1'},
      {'pollen', 1, 7, group = 1, image = '3.2', rotation = 2},
      {'pollen', 2, 1, group = 2, image = '4.1', rotation = 1},
      {'pollen', 2, 7, group = 2, image = '4.2'},
      {'pollen', 2, 5, group = 3, image = '1.1'},
      {'pollen', 3, 6, group = 3, image = '1.2'},
      {'butterfly', 1, 4, dir = 1},
    },
  },
  [20] = {
    ...
    objs = {
      ...
      {'pollen', 0, 3, group = 1, image = '1.1'},
      {'pollen', 1, 3, group = 1, image = '1.2'},
      {'pollen', 3, 3, group = 2, image = '4.1'},
      {'pollen', 2, 4, group = 2, image = '4.2'},
      {'pollen', 3, 5, group = 3, image = '3.2'},
      {'pollen', 5, 5, group = 3, image = '3.1'},
      {'butterfly', 2, 6, dir = 3},
    },
  },
  ...
  [21] = {
    ...
    objs = {
      ...
      {'bloom', 4, 5},
      {'pollen', 1, 3, group = 1, image = '1.1'},
      {'pollen', 2, 3, group = 1, image = '1.2'},
      {'pollen', 2, 4, group = 2, image = '3.2'},
      {'pollen', 3, 4, group = 2, image = '3.1'},
  ...
  [22] = {
    ...
    objs = {
      ...
      {'weeds', 2, 2},
      {'bloom', 2, 5},
      {'pollen', 2, 7, group = 1, image = '4.1'},
      {'pollen', 2, 8, group = 1, image = '4.2'},
      {'pollen', 1, 5, group = 2, image = '5.1'},
      {'pollen', 1, 6, group = 2, image = '5.2'},
      {'pollen', 3, 5, group = 3, image = '1.1'},
      {'pollen', 3, 6, group = 3, image = '1.2'},
  ...
  [23] = {
    ...
    objs = {
      ...
      {'bloom', 5, 5},
      {'bloom', 4, 3},
      {'pollen', 5, 0, group = 1, image = '1.1'},
      {'pollen', 5, 3, group = 1, image = '1.2'},
      {'pollen', 5, 1, group = 2, image = '4.1'},
      {'pollen', 5, 2, group = 2, image = '4.2'},
  ...
  [24] = {
    ...
    objs = {
      ...
      {'bloom', 1, 6},
      {'bloom', 1, 7},
      {'pollen', 1, 2, group = 1, image = '2.1'},
      {'pollen', 1, 8, group = 1, image = '2.2'},
      {'pollen', 3, 2, group = 2, image = '1.1'},
      {'pollen', 3, 4, group = 2, image = '1.2'},
      {'pollen', 1, 5, group = 3, image = '4.1'},
      {'pollen', 3, 5, group = 3, image = '4.2'},
      {'chameleon', 2, 5, range_x = -3},
      {'butterfly', 2, 1, dir = 1},
    },
  },
  ...
  [25] = {
    ...
    objs = {
      ...
      {'bloom', 4, 5},
      {'bloom', 5, 5},
      {'pollen', 6, 2, group = 1, image = '1.1'},
      {'pollen', 7, 2, group = 1, image = '1.2'},
      {'pollen', 6, 4, group = 2, image = '2.1'},
      {'pollen', 7, 4, group = 2, image = '2.2'},
      {'pollen', 6, 6, group = 3, image = '3.2'},
      {'pollen', 7, 6, group = 3, image = '3.1'},
      {'butterfly', 0, 3, dir = 2},
    },
  },
  [26] = {
    ...
    objs = {
      ...
      {'pollen', 3, 1, group = 1, image = '2.2', rotation = 0.2},
      {'pollen', 3, 2, group = 1, image = '2.1', rotation = 2},
      {'pollen', 5, 1, group = 2, image = '3.2'},
      {'pollen', 5, 2, group = 2, image = '3.1', rotation = -1},
      {'butterfly', 1, 4, dir = 1},
    },
  },
  [27] = {
    ...
    objs = {
      ...
      {'bloom', 3, 6},
      {'bloom', 5, 6},
      {'pollen', 3, 8, group = 1, image = '1.1', rotation = 1},
      {'pollen', 3, 9, group = 1, image = '1.2'},
      {'pollen', 5, 8, group = 2, image = '3.1', rotation = -1},
      {'pollen', 5, 9, group = 2, image = '3.2', rotation = -1},
  ...
  [28] = {
    ...
    objs = {
      ...
      {'pollen', 3, 2, group = 1, image = '1.1'},
      {'pollen', 3, 4, group = 1, image = '1.2'},
      {'pollen', 1, 5, group = 2, image = '2.1'},
      {'pollen', 2, 5, group = 2, image = '2.2'},
